...
ここでは、他の章で解説してこなかった標準的な関数をまとめます。

## 関数のAPIの記述方法

このドキュメント上で引数や戻りの型を記述するためのシンタックスを最初に決めておきます。
...
なお、３次元のベクトル限定の機能や4次元のベクトル限定の機能の場合は、
f32v3やf32v4と構成要素の型のあとにベクトル表すv、そして次元の数の3や4をつけます。
