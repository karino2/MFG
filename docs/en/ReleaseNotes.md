...
- `fore_color()` and `back_color()` allow you to obtain the currently selected color of the app's brush and its back color([Reference: User Defined and Bultin Functions](Reference/BuiltinFunctions.md))
